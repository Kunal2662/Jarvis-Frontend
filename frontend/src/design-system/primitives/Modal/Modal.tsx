...
>(({ className, children, size = 'md', hideClose, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'glass glass-strong fixed left-1/2 top-1/2 z-modal grid w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-2xl p-6 shadow-e4 outline-none data-[state=open]:animate-scale-in',
        sizes[size],
        className,
      )}
      {...props}
